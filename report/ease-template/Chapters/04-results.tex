...
decoding parameters ($T=0$, 1{,}024 max tokens), and $k=3$ retrieval
settings, so that the only varying factor is the retrieval strategy. Dense
indexes use \texttt{Qwen3-Embedding-4B}; BM25 uses Okapi BM25 with a standard
implementation.
...
\begin{table}[!ht]
    ...
    \begin{tabular}{lrrrrrrr}
        ...
        \midrule
        No RAG           & \textbf{1.000} & 0.798 & 0.888 & 0.973 & 0.899 & \textbf{0.0\%} & 0.935 \\
        Dense            & 0.972 & \textbf{0.972} & \textbf{0.972} & \textbf{0.991} & \textbf{0.981} & 0.9\% & 0.975 \\
        BM25             & 0.964 & \textbf{0.972} & 0.968 & 0.989 & 0.980 & 1.2\% & 0.975 \\
        Hybrid           & 0.976 & 0.964 & 0.970 & 0.990 & 0.978 & 0.8\% & 0.976 \\
        Behavior         & \textbf{1.000} & 0.782 & 0.878 & 0.964 & 0.891 & \textbf{0.0\%} & \textbf{0.977} \\
        Contrastive      & 0.996 & 0.948 & 0.971 & 0.990 & 0.973 & \textbf{0.1\%} & 0.927 \\
        Beh.\ + Contr.   & \textbf{1.000} & 0.788 & 0.881 & 0.966 & 0.894 & \textbf{0.0\%} & 0.974 \\
        \bottomrule
    \end{tabular}
\end{table}
